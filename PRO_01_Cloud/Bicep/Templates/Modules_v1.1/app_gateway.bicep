...
//description of Admin username for the backend server
param adminUsername string

//description of Password for the admin account on the backend servers
@secure()
param adminPassword string

//description of Location for all resources.
param location string = resourceGroup().location

//description of Size of the virtual machine.
